...
const main = (argv) => {
  ...
  if (command !== void 0) {
    if (isValidCommand(command)) {
      compose(printCommandMessage, exitProgram)(command);
    }

    compose(printCommandErrorMessage, exitProgram)(command);
  }

  compose(getGreetingMessage, print, exitProgram)(PROJECT_NAME);
};
